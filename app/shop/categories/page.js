...
function getCategoryIcon(name = "") {
  switch (name) {
    ...
    case "3akarat_w_wazaef":
      return (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3a1.5 1.5 0 011.5-1.5h1.5a1.5 1.5 0 011.5 1.5v3" />
        </svg>
      );
    case "al3ab_atfal":
      return (
    ...
    case "lawazem_cars":
      return (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM15.75 18.75a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM3.75 12l1.35-4.05A2.25 2.25 0 017.23 6.5h9.54a2.25 2.25 0 012.13 1.45L20.25 12m-16.5 0h16.5m-16.5 0v5.25c0 .414.336.75.75.75h1.5a.75.75 0 00.75-.75V15m10.5 2.25h1.5c.414 0 .75-.336.75-.75V12" />
        </svg>
      );
...
export default async function Shop_categories_page() {
  ...
  return (
    <main className="relative min-h-screen bg-zinc-950 pt-6 pb-12 lg:pt-8 lg:pb-20 px-4 sm:px-6 lg:px-8 dir-rtl overflow-hidden">
      {/* خلفية Ambient Glows */}
      <div className="absolute top-1/4 right-10 h-96 w-96 rounded-full bg-amber-500/5 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/3 left-10 h-96 w-96 rounded-full bg-amber-600/5 blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-8">
        ...
        {categories && categories.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-zinc-800/80 text-zinc-400 border border-zinc-700/50 group-hover:bg-amber-500/10 group-hover:border-amber-500/30 group-hover:text-amber-400 transition-all duration-300">
                    <svg className="w-4 h-4 transition-transform duration-300 group-hover:-translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.2">
          ...
          <div className="w-full text-center py-20 bg-zinc-900/40 rounded-3xl border border-zinc-800/80 text-zinc-400 space-y-3">
            <p className="text-base font-semibold">لا توجد تصنيفات متاحة حالياً</p>
          </div>
        )}
